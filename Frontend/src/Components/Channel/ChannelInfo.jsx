    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-lg w-full transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      <div className="pt-16 pb-4 px-4">
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          {/* Subscribe button */}
          <div>
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full text-sm transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400">
              {channelInfo.isSubcribed ? "Subscribed" : "Subscribe"}
            </button>
          </div>
        </div>
      </div>
